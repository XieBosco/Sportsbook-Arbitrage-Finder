...
LOG_DIR = "C:\\Users\\fiona\\Desktop\\arbitrage_tool\\sportsbook-arb-finder\\scripts\\betano_messages"
...
def on_message(ws, message):
    ...
    if data.get("method") == "Network.responseReceived":
        ...
        if "api/live/overview" in url and "betano.ca" in url and "application/json" in mime:
...
def main():
    ...
    print(f"Waiting for Betano traffic...")
    print(f"Make sure to REFRESH the Betano Sportsbook page to capture the initial JSONs!")
    ws.run_forever()
